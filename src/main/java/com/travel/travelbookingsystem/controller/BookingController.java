...
// * 5. createBooking(Booking booking, Long passengerId, Long transportId): Create a booking for any transport type.
...
//    }
//
//    // Create a booking for any transport type
...
//                                           @PathVariable Long transportId) {
//        try {
//            Booking savedBooking = bookingService.createBooking(booking, passengerId, transportId, booking.getTravelDate());
//            return ResponseEntity.status(HttpStatus.CREATED).body(savedBooking);
//        } catch (IllegalArgumentException e) {
//            return ResponseEntity.status(HttpStatus.BAD_REQUEST).body("Invalid booking request: " + e.getMessage());
//        } catch (IllegalStateException e) {
